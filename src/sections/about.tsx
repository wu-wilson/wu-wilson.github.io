...
const paragraphs = [
  ...
  "Most of my work focuses on systems that need to stay fast, reliable, and scaleable. I like turning complex technical problems into simple, intuitive experiences.",
